...
Every application in [Settlement patterns](../markets/patterns.md) is a composition of this table — nothing else. If a use case can't be expressed here, the answer is a better composition, not a new opcode: the deployed surface is intentionally narrow, and widening it requires an explicit protocol and governance decision.
